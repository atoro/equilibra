  ...
  <table width="950" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <?php
        ...
        <tr>
          <td width="158" height="174" align="center" valign="top"><table width="180" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="113" valign="top"><img src="imagenes/clientes/1.jpg" width="180" height="113"></td>
            </tr>
            <tr>
              <td height="43" class="texto"><?php echo str_replace("\r\n","<br>",$rs["cliente"]);  ?></td>
            </tr>
          </table></td>
          <?php if($rs=mysql_fetch_array($sentencia,$mibase)){ ?>
          <td width="158" align="center" valign="top"><table width="180" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="113" valign="top"><img src="imagenes/clientes/1.jpg" width="180" height="113"></td>
            </tr>
            <tr>
