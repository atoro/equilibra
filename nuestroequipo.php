      ...
      <td height="393" valign="top"><table width="950" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="317" height="364" valign="top"><table width="310" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="48" class="destacados">Leonardo Medina Fuentes</td>
            </tr>
            <tr>
              <td valign="top" class="texto">Ingeniero constructor UTEM, Empresario de la <br>
                construcci&oacute;n y sector inmobiliario con Empresa <br>
                Rukahue e Inmobiliaria San Martin. A prestado <br>
                servicios en el &aacute;rea publica tanto en servicios <br>
                p&uacute;blicos como municipalidades y en el &aacute;rea privada</td>
            </tr>
          </table></td>
          <td width="316" align="center" valign="top"><table width="310" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="200" valign="top"><img src="imagenes/nuestroequipo/2.jpg" width="310" height="200"></td>
            </tr>
            <tr>
              <td height="48" class="destacados">Milissen Cant&iacute;n Aranda</td>
            </tr>
            <tr>
              <td valign="top" class="texto"><p>Ingeniero Agr&oacute;nomo y Mag&iacute;ster en Gesti&oacute;n Ambiental Territorial con&nbsp; Post t&iacute;tulo en Agroecolog&iacute;a y Desarrollo Rural Sustentable.&nbsp;</p>
                <p> A prestado servicios en el &aacute;rea publica tanto en servicios p&uacute;blicos como municipalidades </p>
                <p>y en el &aacute;rea privada</p></td>
            </tr>
          </table></td>
          <td width="317" align="right" valign="top"><table width="310" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="200" valign="top"><img src="imagenes/nuestroequipo/3.jpg" width="310" height="200"></td>
            </tr>
            <tr>
              <td height="48" class="destacados">Macarena Mellado Arana</td>
            </tr>
            <tr>
              <td valign="top" class="texto"><p>Periodista de la Pontificia Universidad Cat&oacute;lica de Valpara&iacute;so (PUCV), Diplomada Internacional en Comunicaci&oacute;n Empresarial de las Universidades Diego Portales y Pompeu Fabra (Espa&ntilde;a). </p>
                <p>Diplomada en Comunicaci&oacute;n en Cambio Clim&aacute;tico </p>
                <p>de la U Internacional, y Eficiencia Energ&eacute;tica de la PUCV.</p></td>
            </tr>
          </table></td>
        </tr>
      </table></td>
